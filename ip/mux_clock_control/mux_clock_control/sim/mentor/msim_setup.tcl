...
alias com {
  ...
  set common_design_files [dict values [mux_clock_control::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [mux_clock_control::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
